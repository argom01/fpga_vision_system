...
# Path of this script: C:\Users\hhhh\rekonfigi\video_passthrough_kria\KriaApp_system\_ide\scripts\debugger_kriaapp-default.tcl
# 
# 
# Usage with xsct:
# To debug using xsct, launch xsct and run below command
# source C:\Users\hhhh\rekonfigi\video_passthrough_kria\KriaApp_system\_ide\scripts\debugger_kriaapp-default.tcl
# 
...
set bp_22_29_fsbl_bp [bpadd -addr &XFsbl_Exit]
con -block -timeout 60
bpremove $bp_22_29_fsbl_bp
targets -set -nocase -filter {name =~ "*A53*#0"}
rst -processor
