...
#
# Generated by export_simulation on Mon Apr 27 11:15:30 +0200 2026
#
################################################################################
...
'-reset_run' switch to the './rgb2ycbcr_1.sh' script.

./rgb2ycbcr_1.sh -reset_run
...
./rgb2ycbcr_1.sh -noclean_files

For more information on the script, please type './rgb2ycbcr_1.sh -help'.
